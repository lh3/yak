...
#define YAKS_VERSION "0.1-r78-dirty"
...
void yak_ch_selmerge(yak_ch_t *h0, yak_ch_t *h1, int min, int max, int add_new, int n_thread); // merge h1 into h0 and destroy h1 afterwards
